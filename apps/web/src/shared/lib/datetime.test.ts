...
describe('formatDateTime', () => {
  ...
  it('defaults to the host timezone when the caller omits timeZone', () => {
    ...
    expect(formatDateTime('2026-08-17T09:10:01.000Z')).toBe('2026-08-17 17:10:01');
    expect(formatDateTime('2026-08-17T09:10:01.000Z', { withOffset: true })).toBe(
      '2026-08-17 17:10:01 UTC+8',
    );
  });
