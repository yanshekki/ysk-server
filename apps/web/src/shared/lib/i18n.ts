...
const resources = {
  'zh-TW': {
    translation: {
      ...
      projects: {
        title: '專案',
        subtitle: '建立 → 一鍵 Deploy（真 Node 監聽）→ Publish Nginx → Health curl',
        create: '建立專案',
        empty: '尚未建立專案',
        name: '名稱',
        domain: '域名（選填）',
  ...
  en: {
    translation: {
      ...
      projects: {
        title: 'Projects',
        subtitle: 'Create → one-click Deploy (real Node listen) → Publish Nginx → Health',
  ...
  'zh-CN': {
    translation: {
      ...
      projects: {
        title: '项目',
        subtitle: '创建 → 一键 Deploy（真 Node 监听）→ Publish Nginx → Health',
        create: '创建项目',
        empty: '尚未创建项目',
        name: '名称',
        domain: '域名（可选）',
