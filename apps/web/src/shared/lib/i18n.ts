...
const projectsZhTw = {
  ...
  next: {
    ...
    deployTitle: '下一步：部署',
    deployBody: '按右上角 Deploy 啟動 runtime，或到「部署」分頁用 Git。',
    nginxTitle: '下一步：發布 Nginx',
    nginxBody: '到「網路」分頁 Publish Nginx（可選 SSL）。',
  },
  healthDetail: {
    none: '尚未執行健康檢查',
    overall: '結果',
  ...
  sectionPhpDeployDesc: '寫入 PHP 站點 / pool 並依環境套用',
  sectionStaticDeploy: '靜態內容',
  sectionStaticDeployDesc: '靜態站以檔案 + Nginx 為主，無 Node 行程',
  staticDeployHint: '請用 Git 拉取內容，再到「網路」Publish Nginx。',
  noDomain: '未設定域名',
  lastDeploy: '上次部署',
  neverDeployed: '尚未部署',
  created: '已建立 {{name}}',
