...
const commonZhTw = {
  ...
  needRoot: '需 root',
  needExecuteRoot: '需 YSK_EXECUTE 與 root',
  writtenOnly: '已寫入管理檔，未套用到系統',
  applyToLive: '套用後才生效',
  saveDraft: '儲存草稿',
};
...
const commonEn = {
  ...
  writtenOnly: 'Written to panel data; not applied on host',
  applyToLive: 'Apply to take effect',
...
const resources = {
  'zh-TW': {
    translation: {
      ...
      security: {
        title: '帳號安全',
        allowlist: '工具 Allowlist',
        llmUntrusted: 'LLM 輸出不可直接執行',
        pending: '待審批',
