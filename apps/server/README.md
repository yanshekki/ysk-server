...
- `ysk-server`, `ysk-server-shared`, and `ysk-server-core` ship **1.1.18**.
...
| [ysk-server-shared](https://www.npmjs.com/package/ysk-server-shared) | Types and locales (1.1.20) |
| [ysk-server-core](https://www.npmjs.com/package/ysk-server-core) | Hosting and security core (1.1.20) |
