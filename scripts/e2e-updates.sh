...
log "Unit tests…"
pnpm --filter @ysk/core exec vitest run src/update/summary.test.ts
pnpm --filter @ysk/web exec vitest run src/shared/hooks/useUpdatesNavBadge.test.ts src/shared/nav/features.test.ts 2>/dev/null \
