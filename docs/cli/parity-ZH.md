...
**狀態：C3（2026-08-12）。** Phase 4 封板作廢。**VPN／VNC／Apache／服務埠暴露／Real-IP／Panel TLS** 已對齊。剩餘：updates／software／db／redis／ftp／email／dns／runtime（C4–C7）。
