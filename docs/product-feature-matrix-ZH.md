...
**狀態:** 產品契約（準則來源）  
**重計：** 2026-08-20 — 對齊 **1.1.19**（E2E-11118 leftover：Cosmos 分段 state-sync、Hoodi lighthouse v8.2.2、NEAR 12g、Avax opendns、P2P UDP、即時流量、官方版本選擇）。只連官方網站，不接錢包。shared／core／產品同一版本。標記對齊已交付程式（面板 + CLI + API），不是行銷。    
