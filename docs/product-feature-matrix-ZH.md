...
**狀態:** 產品契約（準則來源）  
**重計：** 2026-08-20 — 對齊 **1.1.18**（E2E-11117 leftover：Cosmos v28 state-sync、Hoodi sigp checkpoint、Aptos nofile 1048576、NEAR 8g）。只連官方網站，不接錢包。shared／core／產品同一版本。標記對齊已交付程式（面板 + CLI + API），不是行銷。   
