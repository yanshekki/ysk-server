...
**狀態:** 產品契約（準則來源）  
**重計：** 2026-08-20 — 對齊 **1.1.17**（E2E-11116 leftover：Cosmos 官方 genesis、Avalanche C-Chain 設定、Hoodi checkpoint、Aptos nofile、NEAR 4g）。只連官方網站，不接錢包。shared／core／產品同一版本。標記對齊已交付程式（面板 + CLI + API），不是行銷。   
