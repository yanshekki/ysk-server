...
| 項 | 說明 |
|----|------|
| Line coverage → 90% | 2026-07-28 連續補測：**~45% → ~62% stmts**（295 tests）；幾乎清零 0% 實作模組（剩 schema/types）— 持續 track 至 90% |
| Phase 3 platform | Users/Packages **有 core API + 測試**；完整多租戶 UI/計費 — 新產品線 |
