...
```bash
COVERAGE_FLOOR=0 pnpm --filter @ysk/shared test:coverage
COVERAGE_FLOOR=0 pnpm --filter @ysk/core test:coverage
COVERAGE_FLOOR=0 pnpm --filter @ysk/server test:coverage
COVERAGE_FLOOR=0 pnpm --filter @ysk/web test:coverage
```
