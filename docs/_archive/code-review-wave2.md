...
| H4 DTOs in `@ysk/shared` only | Domain modules; web re-exports |
...
| **R1** | Shared DTO domainization | Domain DTO files in `@ysk/shared`; web/core wired |
...
| W2-04 | DTO sprawl | `@ysk/shared` domain modules |
