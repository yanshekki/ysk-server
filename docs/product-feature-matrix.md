...
**Rescored:** 2026-08-18 — **1.1.7** (npm latest after 1.1.6). E2E-1116: validator disk honesty + Software tab, host-timezone clocks, FTP localhost/FTPS gate, self-update stream. Marks match shipped code (panel + CLI + API), not marketing.
