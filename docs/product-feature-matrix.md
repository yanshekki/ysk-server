...
**Rescored:** 2026-08-20 — **1.1.19** (E2E-11118 leftover: Cosmos section-scoped state-sync, Hoodi lighthouse v8.2.2, NEAR 12g, Avax opendns, P2P UDP, live traffic, official version picker). Official links only; no wallet connect. shared/core/product same version. Marks match shipped code (panel + CLI + API), not marketing.
