...
**Rescored:** 2026-08-20 — **1.1.17** (E2E-11116 leftover: Cosmos official genesis, Avalanche C-Chain config, Hoodi checkpoint, Aptos nofile, NEAR 4g; unified LogViewer). Official links only; no wallet connect. shared/core/product same version. Marks match shipped code (panel + CLI + API), not marketing.
