...
**Rescored:** 2026-08-13 — seal after Waves A–C; **1.0.10** ships remaining 1.0.8 audit remediations (A08-22–A08-29). Marks match shipped code (panel + CLI + API), not marketing.
