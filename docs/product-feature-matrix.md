...
**Rescored:** 2026-08-18 — **1.1.10** (npm latest after 1.1.9). E2E-1119: DNS start fail card shows bind/journal; validator wizard install after mainnet ack + confirm; About tab profile comparison. shared/core/product same version. Marks match shipped code (panel + CLI + API), not marketing.
