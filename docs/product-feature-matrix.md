...
**Rescored:** 2026-08-20 — **1.1.18** (E2E-11117 leftover: Cosmos v28 state-sync, Hoodi sigp checkpoint, Aptos nofile 1048576, NEAR 8g). Official links only; no wallet connect. shared/core/product same version. Marks match shipped code (panel + CLI + API), not marketing.
