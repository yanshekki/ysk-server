...
**Rescored:** 2026-08-20 — **1.1.22** (validator wizard RAM-short Install with type-to-confirm). Official links only; no wallet connect. shared/core/product same version. Marks match shipped code (panel + CLI + API), not marketing.
