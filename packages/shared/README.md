...
<h1 align="center">ysk-server-shared</h1>

<p align="center">
  Types, DTOs, locales, and helpers for
  <a href="https://www.npmjs.com/package/ysk-server"><strong>YSK Server</strong></a>.
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/ysk-server-shared"><img alt="ysk-server-shared" src="https://img.shields.io/npm/v/ysk-server-shared.svg?style=flat-square&color=2ea043" /></a>
...
| **Sibling** | [ysk-server-core](https://www.npmjs.com/package/ysk-server-core) |
| **Source** | [github.com/yanshekki/ysk-server](https://github.com/yanshekki/ysk-server) (`packages/shared`) |
| **License** | MIT |
