...
name: ysk-server
description: >
  Operate and install YSK Server v1.0.39 — free single-host Linux control plane.
...
# YSK Server (v1.0.39) — Agent skill
...
ysk-server projects git status --id UUID --json
ysk-server migrate inventory --json
ysk-server hosting leftovers --json
